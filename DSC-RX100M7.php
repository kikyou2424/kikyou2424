...
<body>
    ...
    <div id="pro-list" class="min-w1210">
        <div class="pro-list inner">
            <div class="pro-list1">
                <div style="background: url(https://www.sonystyle.com.cn/content/dam/sonystyle/products/cyber-shot/dsc_rx100m7/product/img_dsc_rx100m7_20201228.jpg) no-repeat center;background-size: cover;"></div>
                <ul class="clearfix">
