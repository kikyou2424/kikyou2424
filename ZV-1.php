...
<head>
    ...
    <title>索尼Vlog camera ZV-1_Sony Vlog camera ZV-1_数码相机|报价,价格,配置,详情-索尼中国在线商城</title>
...
<body>
    ...
    <div id="pro-list" class="min-w1210">
        <div class="pro-list inner">
            ...
            <div id="smallbox" style="https://www.sonystyle.com.cn/content/dam/sonystyle/products/cyber-shot/zv_1/product/img_zv_1_x_20210104_2.jpg) no-repeat center;background-size: cover;">                  
                    <div id="mask"></div>
                </div>
                <div id="bigbox" >
                    <img id="bigImg" src="https://www.sonystyle.com.cn/content/dam/sonystyle/products/cyber-shot/zv_1/product/img_zv_1_x_20210104_2.jpg" alt="">
                </div>   
    <script>
        function $id(id){
		...
		smallBox.onmouseleave = function(){
			...
			mask.style.display = "none";
                ...
                <ul class="clearfix">
                    <li><img src="https://www.sonystyle.com.cn/content/dam/sonystyle/products/cyber-shot/zv_1/product/img_zv_1_x_20210104_2.jpg" alt=""></li>
                    <li><img src="https://www.sonystyle.com.cn/content/dam/sonystyle/products/cyber-shot/zv_1/product/img_zv_1_b_20200526_2.jpg.thumb.537.537.png.thumb.64.64.png" alt=""></li>
                    <li><img src="https://www.sonystyle.com.cn/content/dam/sonystyle/products/cyber-shot/zv_1/product/img_zv_1_b_20200526_3.jpg.thumb.537.537.png.thumb.64.64.png" alt=""></li>
                    <li><img src="https://www.sonystyle.com.cn/content/dam/sonystyle/products/cyber-shot/zv_1/product/img_zv_1_b_20200526_4.jpg.thumb.537.537.png.thumb.64.64.png" alt=""></li>
                    <li><img src="https://www.sonystyle.com.cn/content/dam/sonystyle/products/cyber-shot/zv_1/product/img_zv_1_b_20200526_5.jpg.thumb.537.537.png.thumb.64.64.png" alt=""></li>
                    <li><img src="https://www.sonystyle.com.cn/content/dam/sonystyle/products/cyber-shot/zv_1/product/img_zv_1_b_20200526_6.jpg.thumb.537.537.png.thumb.64.64.png" alt=""></li>
                </ul>
                <div>
            ...
            <div class="pro-list2">
                <div>
                    <img src="./images/pro2_03.png" alt="">
                    <div class="num_m">
                ...
                <div class="addCart">
                    <div id="addcart">
                        <img src="https://www.sonystyle.com.cn/etc/designs/sonystyle/images/buybutton/button_cartaddition_big.png" alt="加入购物车">
                    </div>
    ...
    <script>
        ...
        $('#addcart').click(function(){
            $.ajax({
                ...
                data:{
                    id:1,
                    name:'Vlog 相机 ZV-1 白色 无线蓝牙手柄套装 许光汉明星同款',
                    img:'https://www.sonystyle.com.cn/content/dam/sonystyle/products/cyber-shot/zv_1/product/img_zv_1_vpt2bt_x_20210104.jpg',
                    price:4799,
